...
public class CompassActivity extends SimpleTestActivity implements
		SensorEventListener {
	...
	public void onSensorChanged(SensorEvent event) {
		...
		if (gravity != null && geomag != null) {
			...
			if (success) {
				...
				deltaDegree *= -1;
				m_Matrix.postRotate(deltaDegree, m_ImgView.getDrawable()
						.getBounds().width() / 2, m_ImgView.getDrawable()
						.getBounds().height() / 2);
				m_fLastDegree = flAz;
